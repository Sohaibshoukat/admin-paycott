        ...
        <div>
            <div className="flex flex-col gap-4 lg:flex-row justify-between font-pop lg:items-center">
                <div className="flex gap-2 md:gap-6 items-center">
                    <h3 className='text-gray-400 text-sm md:text-lg font-medium'>Total 12 Active Accounts</h3>
                </div>
            ...
            <div className='bg-transparent overflow-x-auto font-pop w-full my-2 md:my-6'>
                <table className='w-full overflow-x-scroll font-pop border-spacing-y-4 border-separate'>
                    <thead>
                        ...
                        <th scope="col" class="px-2 md:px-6 py-1 md:py-3 text-left w-[30%] font-medium text-gray-500 uppercase">User</th>
                        <th scope="col" class="px-2 md:px-6 py-1 md:py-3 text-left font-medium text-gray-500 uppercase">Type</th>
                                ...
                                <td class="px-2 md:px-6 bg-white my-3 py-1 md:py-3 text-left font-semibold ">
                                    <div
                                        className={`
                                            ...
                                            ${item?.Status == "Application" ? "bg-[#3992F2]/10 border-[#3992F2] text-[#3992F2]"
                                ...
                                <td class="px-2 md:px-6 rounded-r-2xl text-gray-400 bg-white my-3 py-1 md:py-3 text-left ">
                                    <div className="flex gap-4 font-pop items-center">
                                        <button
                                            ...
                                            onClick={() => { navigate("/admin-dashboard/business-center/active-detail") }}
                                        >
                                            Detail
                                        </button>
                                    </div>
