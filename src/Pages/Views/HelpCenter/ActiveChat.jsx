            ...
            <div className='bg-transparent overflow-x-auto font-pop w-full my-2 md:my-6'>
                <table className='w-full overflow-x-scroll font-pop border-spacing-y-4 border-separate'>
                    <thead>
                        ...
                        <th scope="col" class="px-2 md:px-6 py-1 md:py-3 text-left font-medium text-gray-500 uppercase">Re-Assign</th>
                            ...
                            <tr key={index}>
                                ...
                                <td class="px-2 md:px-6 font-pop text-sm md:text-base bg-white my-3 py-3 text-left ">
                                    <select 
                                        name="" 
                                        id=""
                                        className='border-2 bg-white border-lightGrey py-2 px-4 rounded-lg'
                                    >
                                ...
                                <td class="px-2 md:px-6 rounded-r-2xl text-gray-400 bg-white my-3 py-1 md:py-3 text-left ">
                                    <div className="flex gap-4 font-pop items-center">
                                        <button className='bg-primarygreen w-max border-2 border-primarygreen py-2 px-4 rounded-full text-white hover:text-primarygreen hover:bg-transparent ease-in-out duration-300'>
                                            Re-Assign
                                        </button>
                                        <button
